		...
		<?php include('views/navbar.php'); ?>
            ...
            <div class="container animate-box">
                    ...
                    <?php
                        ...
                        $stm = "SELECT * FROM order_class WHERE member_id='".$memId."' AND isPaid='paid'";

                        if($result = mysqli_query($display->conn, $stm)){
                            $rowcount=mysqli_num_rows($result);

                            if($rowcount == 0){
                                echo '<br><br><br><br><h4 class="text-center">No transaction made!</h4><br><br>';
                            }else{
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-toggle="modal" data-target="#viewDetails'.$row['id'].'">View Details</button>
                                    </td>
                                </tr>';
                            }
                        }
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row" style="text-align:left;">
                                        ...
                                        <div class="col-sm-9">'.$cl['max_cap'].'</div>
                                    </div>
                                    <div class="row" style="text-align:left;">
