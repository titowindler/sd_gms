		...
		<div id="fh5co-pricing">
			...
			<div class="container-fluid w3-row-padding" id="about">
                <?php
                    ...
                    $stm = "SELECT * FROM class_service WHERE type='regular' AND status='active'";
                        ...
                        if($ctr > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <div class="w3-container">
                                    ...
                                    <p>'.$displayDesc.'</p>
                                    <p class="text-center"><a href="#"><button class="btn btn btn-primary btn-class-card" data-toggle="modal" data-target="#order'.$id.'">Subcribe Workout Routine</button></a></p>
                                </div>
                                </div>
                            </div>';
                            ...
                            echo '<div id="order'.$id.'" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-footer">
                                        <a href="?service='.$id.'"><button type="button" class="btn btn-primary" style="width:100%;">Proceed To Subscribe</button></a>
                                    </div>
                                    </div>
